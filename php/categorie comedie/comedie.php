...
<html lang="fr">
	<head>
		...
		<meta name="description" content="page contenant les films de la catégorie comédie">
		...
		<link rel="stylesheet" href="comedie.css">
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
		<title>catégorie film comédie du site CINE ADDICT</title>
	</head>
<body>
            ...
            <div class="nav-links">
                ...
                <div class="dropdown">
                    ...
                    <div class="drop-content">
                        <a href="comedie.php" title="lien vers page de la catégorie Comédie ">Comédie</a>
	...
	<main>
		<div class="h1-effect">
			<h1>Voici le top 10 des films dans la catégorie Comédie</h1>
		</div>
        <div class="container">
            <div>
                <p>try to hover me
                ...
                <?php
                $requetesql = "SELECT ID,TITRE FROM FILMS WHERE CATEGORIE = 'COMÉDIE' AND ID = 11";
                ...
                while ($donnee = $filmaction->fetch()) {
                    ...
                    <div>
                        ...
                        <p><?= $donnee['TITRE'] ?> </p>
                        <a href='../presentation%20video/presentation.php?id=<?=$donnee['ID']?>' title="plus d'informations sur le film">Plus d'informations</a>
                    </div>
                    <?php
                }
            ...
            while ($donnee = $filmaction->fetch()) {
                ...
                <div>
                    <img src="../images/<?= $donnee['ID']?>.jpg" alt="affiche de film">
                    <p><?= $donnee['TITRE'] ?> </p>
                    <a href='../presentation%20video/presentation.php?id=<?=$donnee['ID']?>' title="plus d'informztion sur le film">Plus d'informations</a>
                </div>
                <?php
            }
            $filmaction->closeCursor();
        ...
        <div class="row">
            ...
            <div class="row">
                <ul>
                    ...
                    <li><a href="comedie.php" title="liens vers film de comédie">Film de comédie</a></li>
                    <?php
                    if (!isset($_SESSION['IsLog']) OR $_SESSION['IsLog'] == False){
                        ?>
